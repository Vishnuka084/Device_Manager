...
router.post('/delete/:locationId',VerifyToken.verifyToken, LocationController.deleteLocation) //location /delete
router.get('/get/location',VerifyToken.verifyToken, LocationController.viewLocation) //location /get/location?title= 
